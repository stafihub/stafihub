...
type MsgCreateRelayer struct {
	...
	Taipe     string   `protobuf:"bytes,2,opt,name=taipe,proto3" json:"taipe,omitempty"`
...
func (m *MsgCreateRelayer) GetTaipe() string {
	if m != nil {
		return m.Taipe
	}
	return ""
...
func (m *MsgDeleteRelayer) GetTaipe() string {
	if m != nil {
		return m.Taipe
	}
	return ""
...
func (m *MsgUpdateThreshold) GetTaipe() string {
	if m != nil {
		return m.Taipe
	}
	return ""
...
var fileDescriptor_858ee6e4c5f310aa = []byte{
	...
	,
}
...
func (m *MsgCreateRelayer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Taipe) > 0 {
		i -= len(m.Taipe)
		copy(dAtA[i:], m.Taipe)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Taipe)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
