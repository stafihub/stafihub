...
func TestCreateThreshold(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.desc, func(t *testing.T) {
			...
			out, err := clitestutil.ExecTestCLICmd(ctx, cli.CmdCreateThreshold(), args)
			if tc.err != nil {
...
func TestUpdateThreshold(t *testing.T) {
	...
	_, err := clitestutil.ExecTestCLICmd(ctx, cli.CmdCreateThreshold(), args)
	require.NoError(t, err)
	...
	for _, tc := range []struct {
		...
		t.Run(tc.desc, func(t *testing.T) {
            ...
            args = append(args, fields...)
            args = append(args, tc.args...)
			out, err := clitestutil.ExecTestCLICmd(ctx, cli.CmdUpdateThreshold(), args)
			if tc.err != nil {
				require.ErrorIs(t, err, tc.err)
			} else {
				require.NoError(t, err)
...
func TestDeleteThreshold(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.desc, func(t *testing.T) {
            ...
            args = append(args, tc.args...)
			out, err := clitestutil.ExecTestCLICmd(ctx, cli.CmdDeleteThreshold(), args)
			if tc.err != nil {
				require.ErrorIs(t, err, tc.err)
			} else {
				require.NoError(t, err)
