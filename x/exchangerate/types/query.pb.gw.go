...
var (
	filter_Query_GetEraExchangeRate_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Query_GetEraExchangeRate_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_GetEraExchangeRate_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_Query_EraExchangeRatesByDenom_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Query_EraExchangeRatesByDenom_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_EraExchangeRatesByDenom_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_Query_GetExchangeRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"stafiprotocol", "stafihub", "exchangerate", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ExchangeRateAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"stafiprotocol", "stafihub", "exchangerate", "exchangeRateAll"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetEraExchangeRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"stafiprotocol", "stafihub", "exchangerate", "getEraExchangeRate"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_EraExchangeRatesByDenom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"stafiprotocol", "stafihub", "exchangerate", "eraExchangeRatesByDenom"}, "", runtime.AssumeColonVerbOpt(true)))
)
