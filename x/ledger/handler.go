...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgSetPoolStatus:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgForceRmBondedPool:
			res, err := msgServer.ForceRmBondedPool(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgForceUpdateBondedPool:
			res, err := msgServer.ForceUpdateBondedPool(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
