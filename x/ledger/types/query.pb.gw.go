...
var (
	...
	pattern_Query_PoolsByDenom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"stafihub", "ledger", "poolsByDenom", "denom"}, "", runtime.AssumeColonVerbOpt(true)))
