...
var _ sdk.Msg = &MsgToggleValidatorWhitelistSwitch{}

func NewMsgToggleValidatorWhitelistSwitch(creator string) *MsgToggleValidatorWhitelistSwitch {
	return &MsgToggleValidatorWhitelistSwitch{
		Creator: creator,
	}
}

func (msg *MsgToggleValidatorWhitelistSwitch) Route() string {
	return RouterKey
}

func (msg *MsgToggleValidatorWhitelistSwitch) Type() string {
	return TypeMsgToggleValidatorWhitelistSwitch
}
