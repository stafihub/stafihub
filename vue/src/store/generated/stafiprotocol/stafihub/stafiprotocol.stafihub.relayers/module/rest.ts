...
export type RelayersMsgCreateRelayerResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryRelayerAll = (
    ...
    this.request<RelayersQueryAllRelayerResponse, RpcStatus>({
  ...
  queryThresholdAll = (
    ...
    this.request<RelayersQueryAllThresholdResponse, RpcStatus>({
      path: `/stafiprotocol/stafihub/relayers/threshold`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
