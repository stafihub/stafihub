...
import { MsgSetThreshold } from "./types/relayers/tx";
...
const types = [
  ...
  ["/stafiprotocol.stafihub.relayers.MsgSetThreshold", MsgSetThreshold],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgSetThreshold: (data: MsgSetThreshold): EncodeObject => ({ typeUrl: "/stafiprotocol.stafihub.relayers.MsgSetThreshold", value: data }),
