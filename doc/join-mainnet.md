...
If those seeds aren't working, you can find more seeds and persistent peers on a Stafihub explorer (a list can be found on the [launch page](https://stafihub.network/launch)). 
